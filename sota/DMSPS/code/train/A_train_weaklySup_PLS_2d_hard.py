...
def get_program_args():
    ...
    parser.add_argument('--data_root_path', type=str,
                        default='/home/linux/Desktop/WSL4MIS/seg00/DMSPS/data/ACDC2017/ACDC_for2D', help='Name of Experiment')
...
def train_api(root_path, outputdir):
    ...
    snapshot_path = os.path.join(outputdir, "model/{}_{}/{}_{}_{}".format(
    ...
    print("Finshed! save to", snapshot_path)
