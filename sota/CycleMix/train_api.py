...
def get_args_parser():
    ...
    parser.add_argument('--cutout', type=str2bool, default=False, help='true for CutOut')
...
def train(output_dir="./checkpoints/CycleMix", box=False, graph=True, cutout=False, epochs=6000):
