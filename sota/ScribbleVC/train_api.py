...
"""
训练指令：
python train_ACDC.py --root_path /home/linux/Desktop/WSL4MIS/data/ACDC --exp ACDC/111 --bilinear --linear_layer --max_epoches 100  
...
def train(root_path, output_dir, max_epoches=100, exp_name="ACDC/ScribbleVC"):
    global args
