...
python train.py --root_path /home/linux/Desktop/WSL4MIS/data/ACDC --exp 111 --bilinear --linear_layer --fold MAAGfold --max_epoches 200 --weight_cam_subloss 0.25 0.5 0.75 1 --weight_cam 0.1
...
def train(root_path, output_dir, max_epoches=200, exp_name="ACDC/scribformer"):
    ...
    args.max_epoches = max_epoches
    args.exp = exp_name

    args.linear_layer = True  
    args.bilinear = False 
    args.weight_cam_subloss = [0.25, 0.5, 0.75, 1]
    args.weight_cam = 0.1

    # snapshot_path = "./checkpoints/{}_{}/{}".format(args.exp, args.fold, args.sup_type)
    snapshot_path = os.path.join(output_dir, "{}_{}/{}".format(args.exp, args.fold, args.sup_type))
