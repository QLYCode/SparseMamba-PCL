...
import numpy as np
# numpy bugfix: AttributeError: module 'numpy' has no attribute 'bool'.
np.bool = np.bool_
...
color_map = vis_utils.load_color_map(os.path.join(SCRIPT_ROOT, 'misc/colormapvoc.mat'))
...
def parsing_data():
    ...
    if opt.data == 'ACDC':
        ...
        opt.path_data = '/home/linux/Desktop/WSL4MIS/data/ACDC/raw'
...
def train_api():
    ...
    opt.dataset_split = os.path.join(SCRIPT_ROOT, 'splits/split_ACDC.csv')
